...
/**
 * Interfaz Retrofit para la API pública de OpenFoodFacts.
 * No requiere autenticación. Base URL: https://world.openfoodfacts.org/
 * Documentación: https://wiki.openfoodfacts.org/API
 */
interface OpenFoodFactsService {

    /**
     * Busca productos alimentarios por nombre.
